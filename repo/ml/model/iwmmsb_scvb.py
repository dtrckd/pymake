...
class iwmmsb_scvb2(SVB):
    ...
    def _init_params(self, frontend):
        ...
        #frontend._set_rawdata_for_likelihood_computation()
    ...
    def fit(self, frontend):
        ...
        for _it, obj in frontend:
            ...
            if log:
                ...
                log = False
                prop_edge = batch_size / self._len['nnz']

                print('.', end='')
                self.log.info('it %d | prop edge: %.2f, %s, Entropy: %f,  diff: %f' % (_it,
                                                                                       prop_edge,
