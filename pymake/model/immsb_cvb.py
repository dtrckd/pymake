...
class immsb_cvb(GibbsSampler):
    ...
    def _random_s2_init(self):
        ...
        self.N_theta_left = self.gamma.sum(1).sum(1)
        ...
        #    self.frontend.symmetrize(self.N_phi[0])
        #    self.frontend.symmetrize(self.N_phi[1])
